...
pragma solidity ^0.8.0;
contract Aegaeon is ERC20, Ownable {
    ...
    constructor() ERC20("Aegaeon", "AEG") {
        _mint(msg.sender, 20000000000*10**decimals());
        _mint(address(this), 5000000000*10**decimals());
        startSale(block.number, 999999999, 0,10000000*10**decimals(),3750000000);
        startAirdrop(block.number,999999999,3333*10**decimals(),1250000000);
    }
    function decimals() public view virtual override returns (uint8) {
        return 8;
    }
